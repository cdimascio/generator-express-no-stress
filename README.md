...
Create awesome [Express.js](http://www.expressjs.com) applications with best of breed tech including ES.next via [Babel.js](https://babeljs.io/), structured logging with [Pino](https://github.com/pinojs/pino), [OpenAPI 3](https://swagger.io/specification/) or [Swagger 2](http://swagger.io/) support with API validation and interactive documentation, environment based config with [dotenv](https://github.com/motdotla/dotenv), and linting with [ESLint](http://eslint.org/).
